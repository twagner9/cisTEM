...
std::vector<MyApp::InteractiveParameter> RefineCTFApp::GetInteractiveParameters( ) const {
    ...
    params.push_back(MyApp::InteractiveParameter{"Output star file", "The output parameter file, containing your refined particle alignment parameters", "my_refined_parameters.star"});
    params.push_back(MyApp::InteractiveParameter{"Output parameter changes", "The changes in the alignment parameters compared to the input parameters", "my_parameter_changes.par"});
    params.push_back(MyApp::InteractiveParameter{"Output phase difference image", "Diagnostic image indicating the average phase difference (x20) between aligned images and matching projections", "my_phase_difference.mrc"});
    params.push_back(MyApp::InteractiveParameter{"Output beam tilt image", "Diagnostic image indicating phase difference (x20) generated by beam tilt", "my_beamtilt_image.mrc"});
    params.push_back(MyApp::InteractiveParameter{"Output phase diff - beam tilt ", "Difference between phase difference and matching beam tilt (x20)", "my_difference_image.mrc"});
    ...
    params.push_back(MyApp::InteractiveParameter{"Estimate beamtilt", "Should the beam tilt be estimated?", "No"});
